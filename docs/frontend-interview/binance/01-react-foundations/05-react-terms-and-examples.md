---
sidebar_position: 5
sidebar_label: "React 術語與範例"
slug: "/frontend-interview/binance/react-terms-code-examples"
...
> 如果你還不熟悉 `useQuery`、`useMutation`、`useQueryClient` 等第三方 Hooks，建議先讀 [React 常用第三方 Hooks 入門](/docs/frontend-interview/binance/react-third-party-hooks)，再回來看這篇的交易頁範例。
