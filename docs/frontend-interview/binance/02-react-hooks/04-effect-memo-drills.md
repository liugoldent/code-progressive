---
sidebar_position: 4
sidebar_label: "Effect / Memo"
slug: "/frontend-interview/binance/react-effect-memo-hooks-drills"
...
> 實際案例：[useLayoutEffect：交易風險 Tooltip 定位](/docs/frontend-interview/binance/practical-cases/use-layout-effect) · [OneCompiler 可操作版本](https://onecompiler.com/react#draft-8xxa)
...
> 實際案例：[useDebugValue：替行情連線 Hook 顯示可讀狀態](/docs/frontend-interview/binance/practical-cases/use-debug-value)
...
[下一組：Concurrent / External Store Hooks](/docs/frontend-interview/binance/react-concurrent-external-hooks-drills)
