---
sidebar_position: 6
sidebar_label: "React 19 Hooks"
slug: "/frontend-interview/binance/react-19-hooks-drills"
...
> 實際案例：[useActionState：整合交易下單的提交狀態](/docs/frontend-interview/binance/practical-cases/use-action-state)
...
> 實際案例：[useOptimistic：交易下單時先顯示送出中](/docs/frontend-interview/binance/practical-cases/use-optimistic)
...
> 實際案例：[useEffectEvent：行情連線不因通知設定改變而重建](/docs/frontend-interview/binance/practical-cases/use-effect-event)
...
[下一組：Server / Global State 第三方 Hooks](/docs/frontend-interview/binance/third-party-server-global-hooks-drills)
