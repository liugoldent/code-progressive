---
sidebar_position: 3
sidebar_label: "State / Context / Ref"
slug: "/frontend-interview/binance/react-state-context-ref-hooks-drills"
...
> 實際案例：[useState：交易下單數量與衍生金額](/docs/frontend-interview/binance/practical-cases/use-state)
...
> 實際案例：[useReducer：集中管理交易訂單狀態](/docs/frontend-interview/binance/practical-cases/use-reducer)
...
> 實際案例：[useContext：跨元件共用交易偏好](/docs/frontend-interview/binance/practical-cases/use-context)
...
> 實際案例：[useRef：訂單驗證失敗時聚焦欄位](/docs/frontend-interview/binance/practical-cases/use-ref)
...
> 實際案例：[useImperativeHandle：限制價格欄位的命令介面](/docs/frontend-interview/binance/practical-cases/use-imperative-handle)
...
> 實際案例：[useId：建立可重複使用的無障礙訂單欄位](/docs/frontend-interview/binance/practical-cases/use-id)
...
[下一組：Effect / Memo Hooks](/docs/frontend-interview/binance/react-effect-memo-hooks-drills)
