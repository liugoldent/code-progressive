---
sidebar_position: 2
sidebar_label: "Hooks 六題題庫總覽"
slug: "/frontend-interview/binance/react-hooks-six-drills-index"
...
> 第一次接觸或還不確定該選哪個 Hook，先讀：[React Hooks 為什麼存在：常用 Hook 解決問題全覽](/docs/frontend-interview/binance/react-hooks-purpose-guide)
...
| 類別 | 收錄 Hook | 題數 |
| --- | --- | ---: |
| [State / Context / Ref](/docs/frontend-interview/binance/react-state-context-ref-hooks-drills) | `useState`、`useReducer`、`useContext`、`useRef`、`useImperativeHandle`、`useId` | 36 |
| [Effect / Memo](/docs/frontend-interview/binance/react-effect-memo-hooks-drills) | `useEffect`、`useLayoutEffect`、`useInsertionEffect`、`useMemo`、`useCallback`、`useDebugValue` | 36 |
| [Concurrent / External Store](/docs/frontend-interview/binance/react-concurrent-external-hooks-drills) | `useTransition`、`useDeferredValue`、`useSyncExternalStore` | 18 |
| [React 19 新 Hook](/docs/frontend-interview/binance/react-19-hooks-drills) | `useActionState`、`useOptimistic`、`useEffectEvent` | 18 |
| [Server / Global State 第三方 Hook](/docs/frontend-interview/binance/third-party-server-global-hooks-drills) | `useQuery`、`useMutation`、`useQueryClient`、`useSelector`、`useDispatch`、Zustand store Hook | 36 |
| [Router / Form 第三方 Hook](/docs/frontend-interview/binance/third-party-router-form-hooks-drills) | `useNavigate`、`useParams`、`useSearchParams`、`useForm`、`useWatch`、`useFieldArray` | 36 |
| **合計** | **30 種 Hook** | **180 題** |
