---
sidebar_position: 7
sidebar_label: "Server / Global State"
slug: "/frontend-interview/binance/third-party-server-global-hooks-drills"
...
> 實際案例：[`useQuery`：切換並更新交易行情](/docs/frontend-interview/binance/practical-cases/use-query)
...
> 實際案例：[`useMutation`：送出限價單並更新未成交訂單](/docs/frontend-interview/binance/practical-cases/use-mutation)
...
[下一組：Router / Form 第三方 Hooks](/docs/frontend-interview/binance/third-party-router-form-hooks-drills)
