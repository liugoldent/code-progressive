---
sidebar_position: 4
sidebar_label: "第一回補強：State / Effect / Async"
slug: "/frontend-interview/binance/react-state-effect-reinforcement"
...
[回到系列總覽](/docs/frontend-interview/binance/react-live-interview-series) · [入門篇：Props / State / Form / Effect](/docs/frontend-interview/binance/react-foundations-live-demo) · [第一回：State / Effect / Realtime](/docs/frontend-interview/binance/react-state-effect-live-demo) · **第一回補強：State / Effect / Async 組合題** · [第二回：Identity / Render / Concurrent UI](/docs/frontend-interview/binance/react-render-identity-live-demo)
...
- 想繼續挑戰 identity、render 與 concurrent UI：前往 [React 現場實戰題第二回](/docs/frontend-interview/binance/react-render-identity-live-demo)。
- Request race 或 WebSocket 還卡住：回到 [React 現場實戰題第一回](/docs/frontend-interview/binance/react-state-effect-live-demo) 的題目四、五、七。
- 想多練短題：前往 [Vue 轉 React：30 次反射訓練](/docs/frontend-interview/binance/react-reflex-drills)。
