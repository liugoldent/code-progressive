---
sidebar_position: 3
sidebar_label: "第一回：State / Effect / Realtime"
slug: "/frontend-interview/binance/react-state-effect-live-demo"
...
[回到系列總覽](/docs/frontend-interview/binance/react-live-interview-series) · [入門篇：Props / State / Form / Effect](/docs/frontend-interview/binance/react-foundations-live-demo) · **第一回：State / Effect / Realtime** · [第一回補強：State / Effect / Async 組合題](/docs/frontend-interview/binance/react-state-effect-reinforcement) · [第二回：Identity / Render / Concurrent UI](/docs/frontend-interview/binance/react-render-identity-live-demo)
...
如果 `render`、`commit`、browser paint 與 effect 的先後還不熟，先看 [React 一次畫面更新：Trigger → Render → Commit](/docs/frontend-interview/binance/react-state-data)。
...
- 想先用組合題鞏固 state、effect 與 async：前往 [React 現場實戰題第一回補強](/docs/frontend-interview/binance/react-state-effect-reinforcement)。
- 第一回補強能自行推導後，再挑戰 [React 現場實戰題第二回](/docs/frontend-interview/binance/react-render-identity-live-demo) 的 identity、render 與 concurrent UI。
- 想繼續練 React 基礎判斷：回到 [Vue 轉 React：30 次反射訓練](/docs/frontend-interview/binance/react-reflex-drills)。
- 想深入 snapshot + delta：閱讀 [交易產品前端情境題](/docs/frontend-interview/binance/crypto-product-case)。
- 想深入高併發、多分頁與 refetch storm：回到 [Realtime Socket Governance](/docs/frontend-interview/binance/realtime-socket-governance)。
