---
sidebar_position: 5
sidebar_label: "第二回：Identity / Render"
slug: "/frontend-interview/binance/react-render-identity-live-demo"
...
[回到系列總覽](/docs/frontend-interview/binance/react-live-interview-series) · [入門篇：Props / State / Form / Effect](/docs/frontend-interview/binance/react-foundations-live-demo) · [第一回：State / Effect / Realtime](/docs/frontend-interview/binance/react-state-effect-live-demo) · [第一回補強：State / Effect / Async 組合題](/docs/frontend-interview/binance/react-state-effect-reinforcement) · **第二回：Identity / Render / Concurrent UI**
...
- 回到 [系列總覽](/docs/frontend-interview/binance/react-live-interview-series)，混合抽考各篇題目。
- 想補 render / commit 基礎：閱讀 [React / Redux / React Query](/docs/frontend-interview/binance/react-state-data)。
- 想把 render 問題放進 production 效能情境：閱讀 [效能 / 測試 / 前端系統設計](/docs/frontend-interview/binance/quality-performance-system)。
- 想複習 request race 與 realtime correctness：重做 [React 現場實戰題第一回](/docs/frontend-interview/binance/react-state-effect-live-demo)。
- 想用六題組合題銜接第一、二回：前往 [React 現場實戰題第一回補強](/docs/frontend-interview/binance/react-state-effect-reinforcement)。
