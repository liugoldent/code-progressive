---
sidebar_position: 2
sidebar_label: "入門篇：Props / State / Effect"
slug: "/frontend-interview/binance/react-foundations-live-demo"
...
[回到系列總覽](/docs/frontend-interview/binance/react-live-interview-series) · **入門篇：Props / State / Form / Effect** · [第一回：State / Effect / Realtime](/docs/frontend-interview/binance/react-state-effect-live-demo) · [第一回補強：State / Effect / Async 組合題](/docs/frontend-interview/binance/react-state-effect-reinforcement) · [第二回：Identity / Render / Concurrent UI](/docs/frontend-interview/binance/react-render-identity-live-demo)
...
- 下一關是 [React 現場實戰題第一回](/docs/frontend-interview/binance/react-state-effect-live-demo)，會加入 snapshot、stale closure、API race 與 WebSocket。
- 某個名詞仍不熟時，先查 [React 術語中文對照與交易頁範例](/docs/frontend-interview/binance/react-terms-code-examples)。
- 想用更多短題反覆練習：前往 [Vue 轉 React：30 次反射訓練](/docs/frontend-interview/binance/react-reflex-drills)。
